...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('Daltaners Inventory Service')
    .setDescription('Inventory management, stock levels, reservations and adjustments API')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  app.connectMicroservice<MicroserviceOptions>({
    ...
    options: {
      ...
      consumer: {
        groupId: 'daltaners-inventory-service-group',
      },
    },
  });
